...
class AnalyticsService(Protocol):
    ...
    def price_spread(self, limit: int) -> s.PriceSpreadReport: ...
    def stock_ageing(self, idle_days: int) -> s.StockAgeing: ...
    def graph(self, limit: int, min_orgs: int) -> s.GraphView: ...
